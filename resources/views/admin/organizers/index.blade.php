            ...
            <div class="col-md-10">
                <div class="card shadow-lg border-0">
                    <div class="card-header d-flex justify-content-between align-items-center bg-primary text-white">
                        <h5 class="mb-0">{{ __('Organizer Management') }}</h5>
                        <a href="{{ route('admin.organizers.create') }}"
                            class="btn btn-light btn-sm">{{ __('Create New Organizer') }}</a>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        @if ($organizers->isEmpty())
                            <p class="text-center">{{ __('No organizers found.') }}</p>
                        @else
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form action="{{ route('admin.organizers.destroy', $organizer->id) }}"
                                                    ...
                                                    onsubmit="return confirm('{{ __('Are you sure you want to delete this organizer?') }}')">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
