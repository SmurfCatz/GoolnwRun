                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('organizer.register') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="organizer_name" type="text"
                                        class="form-control @error('organizer_name') is-invalid @enderror" name="organizer_name"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="organizer_email" type="email"
                                        class="form-control @error('organizer_email') is-invalid @enderror" name="organizer_email"
                                        value="{{ old('organizer_email') }}" required autocomplete="email">
