                            ...
                            <div class="col-md-4 text-center">
                                <div class="profile-picture-container text-center">
                                    ...
                                    <img id="profile_picture_preview" 
                                         ...
                                         alt="Profile Picture" class="profile-picture" width="150">
                                </div>
                            
                                <!-- ฟอร์มอัปโหลดไฟล์รูปโปรไฟล์ใหม่ -->
                                <input type="file" class="form-control mt-2" id="member_image" name="member_image" onchange="previewImage(event)">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="member_gender" name="member_gender">
                                        ...
                                        <option value="other" {{ $Member->member_gender === 'other' ? 'selected' : '' }}>อื่นๆ</option>
                                    </select>
                                </div>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"
                                                            id="editAddressModalLabel{{ $address->id }}">แก้ไขที่อยู่</h5>
                                                        ...
                                                        <form action="{{ route('address.update', $address->id) }}"
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="address_house_number" name="address_house_number"
                                                                    value="{{ $address->address_house_number }}" required>
                                                            </div>

                                                            <!-- หมู่ที่ -->
                                                            <div class="mb-3">
                                                                <label for="address_village"
                                                                    class="form-label">หมู่ที่</label>
                                                                <input type="text" class="form-control"
                                                                    id="address_village" name="address_village"
                                                                    value="{{ $address->address_village }}">
                                                            </div>

                                                            <!-- ตรอก/ซอย -->
                                                            <div class="mb-3">
                                                                <label for="address_alley"
                                                                    class="form-label">ตรอก/ซอย</label>
                                                                <input type="text" class="form-control"
                                                                    id="address_alley" name="address_alley"
                                                                    value="{{ $address->address_alley }}">
                                                            </div>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="address_road" name="address_road"
                                                                    value="{{ $address->address_road }}">
                                                            </div>

                                                            <!-- ตำบล/แขวง -->
                                                            <div class="mb-3">
                                                                <label for="address_subdistrict"
                                                                    class="form-label">ตำบล/แขวง</label>
                                                                <input type="text" class="form-control"
                                                                    id="address_subdistrict" name="address_subdistrict"
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ $address->address_district }}" required>
                                                            </div>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ $address->address_province }}" required>
                                                            </div>
